<form action="<?php echo Router::url("register");?>" method="post">
        <fieldset>
                <h1>Första gången du handlar här?</h1> <br />
				<div class="italic">If you're not from Sweden and don't have a swedish social security number, please fill in your home country in the box "Land/Country" and then fill in your birth date (YYMMDD) in the first of the two "Personnummer"-boxes. If you have any problems/questions, please contact our customer services at <?php echo Settings::$CustomerserviceEmail; ?></div><br />
                ...
                <input type="text" name="country" value="Sverige"/>
             	 <br /><br />Om du har problem så kontakta <?php echo Settings::$CustomerserviceEmail; ?> så hjälper vi dig.<br /><br />
